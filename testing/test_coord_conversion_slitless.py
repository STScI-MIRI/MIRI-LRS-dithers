...
# THIS SCRIPT WILL TEST THE COORDINATE CONVERSIONS FOR SLITLESS OBSERVATIONS - SINGLE REFERENCE POINT


f = '../test-patterns/test_slitless_det.txt'

xx = lrs_gencoords(mode='slitless', frame='det')
...
coord_comp = lrs_gencoords(mode='slitless', frame='det')
print(coord_comp['c'])
print(' ')
